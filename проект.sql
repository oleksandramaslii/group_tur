CREATE DATABASE MDRD
ON (NAME=DMDR_dat,
FILENAME='D:\Моє\ЛНУ\4 курс\7 семестр.mdf')
LOG ON (NAME=Group_DMDR_Log,
FILENAME='D:\Моє\ЛНУ\4 курс\7 семестр.ldf')
...
insert into klient
values ('9652031247', 'Кушнір', 'Валера', 'НВ', '852146', 'Одеса', 'Приморська', '79', '380660869852','5', '8')
insert into klient
values ('5012469875', 'Михайлишина', 'Олена', 'КП', '854123', 'Червоноград', 'Першотравнева', '12', '380993652148', '11', '12')
insert into klient
values ('1247850325', 'Ракова', 'Настя', 'ДП', '854123', 'Кілія', 'Стеценка', '9', '380672510369', '5', '4')
insert into klient
values ('3452178945', 'Арама', 'Ольга', 'РУ', '541236', 'Вараш', 'Перемоги', '9', '380674258764', '8', '10')
insert into klient
values ('1214578932', 'Поліщак', 'Ірина', 'ТП', '254785', 'Львів', 'Просторова', '35', '380685203654', '6', '2')
insert into klient
values ('1452367858', 'Когут', 'Анастасія', 'ВН', '327854', 'Радехів', 'Пасічна', '42', '380975236952', '16', '1')
insert into klient
...
update klient
Set phone='380632014859'
Where id='2541589630'

update klient
Set misto='Київ'
Where surname='Поліщак'
...
update krayina
Set neobhidnist_viza='Так'
Where name='Туреччина'
...
(id int primary key not null,
id_klient nvarchar(10) not null,
id_eat int not null,
...
insert into putivka
values ('3209', '9652031247', '4305', '987', '111', '3150')
insert into putivka
values ('4238', '5012469875', '4305', '654', '210', '430')
insert into putivka
values ('3079', '1247850325', '6987', '321', '185', '520')
insert into putivka
values ('7029', '3452178945', '6584', '753', '395', '1450')
insert into putivka
values ('4692', '1214578932', '2485', '951', '582', '2500')
insert into putivka
values ('3671', '1452367858', '9654', '751', '254', '680')
insert into putivka
